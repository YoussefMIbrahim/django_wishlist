...
class TestHomePage(TestCase):
    ...
    def test_home_page_shows_empy_list_for_empty_database(self):
...
class TestVisitedPage(TestCase):
    ...
    def test_home_page_shows_empy_list_for_empty_visited_database(self):
...
class TestVisitedList(TestCase):
    ...
    def test_visit_list_contains_visited_places(self):
...
class TestAddNewPlace(TestCase):
    ...
    def test_add_new_unvisited_place(self):
        ...
        new_place_data = {'name':'Tokyo', 'visted' : False}
        ...
        tokyo_from_database = Place.objects.get(name='Tokyo', visted=False)
...
class TestVisitPlace(TestCase):
    ...
    def test_visit_place(self):
        ...
        self.assertTrue(new_york.visted)

    def test_non_existant_place(self):
        visit_nonexistant_place_url = reverse('place_was_visited', args=(4719283, ))
